...
// Lógica para listar as ações do setor (SEGURA COM PREPARED STATEMENTS)
...
<head>
    ...
    <style>
        ...
        .menu-container { 
            ...
            padding: 15px; 
            color: white; 
            /* Estilo para manter o menu visível */
            position: sticky; 
            top: 0; 
            z-index: 1000;
        }
...
<body>
    <div class="menu-container">
        ...
        <a href="cadastrar_meta.php">Cadastrar Meta</a>
        <!-- Nota: cadastrar_meta.php foi mesclado na lógica de processar_meta.php/cadastrar_acao.php -->
        <a href="form_acoes_semanais.php">Calendário Semanal</a>
        <a href="consultar_plano_acao.php">Imprimir Plano de Ação (Setor)</a>
        <a href="calendario_filtrado.php">Visualizar Calendário (Filtros)</a>
        <a href="editar_plano.php">Gerenciar Minhas Ações</a>          
